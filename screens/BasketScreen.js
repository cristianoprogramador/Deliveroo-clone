    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <View className="flex-row justify-between">
            <Text className="text-gray-400">Frete</Text>
            <Text className="text-gray-400">
            <Currency quantity={9.99} currency="BRL" />
            </Text>
          </View>
          ...
          <View className="flex-row justify-between">
            ...
            <Currency quantity={basketTotal + 9.99} currency="BRL" />
            </Text>
          </View>

          <TouchableOpacity 
          onPress={() => navigation.navigate("PreparingOrderScreen")} className="rounded-lg bg-[#00CCBB] p-4"
          >
            <Text className="text-center text-white text-lg font-bold">Realizar o Pedido
            </Text>
          </TouchableOpacity>
        </View>
      </View>
